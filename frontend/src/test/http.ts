...
export const schedule = { id: "s1", projectId: "p1", title: "Design review", description: "Keep description", status: "CONFIRMED", rowVersion: 3, businessRevision: 4, startsAt: "2090-09-10T01:00:00Z", endsAt: "2090-09-10T02:00:00Z", createdBy: "u1", participants: [{ memberUserId: "u1", externalEmail: null, acknowledged: false }, { memberUserId: null, externalEmail: "guest@example.test", acknowledged: false }], changes: [{ businessRevision: 4, type: "CONFIRMED", changedBy: "u1", createdAt: "2090-09-09T00:00:00Z" }] };
...
export function http() {
  ...
  on("GET", "/api/v1/projects/p1/members", () => json([{ userId: "u1", role: "MANAGER" }, { userId: "u2", role: "MEMBER" }]));
